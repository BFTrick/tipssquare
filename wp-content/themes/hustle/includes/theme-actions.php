...
$default_google_fonts = array( 'Arvo', 'Cabin' );
	...
	function woo_custom_styling() {
		...
		if ( is_array($settings) ) {
			...
			if ( $settings['link_color'] != '' ) {
				$output .= '#content a, #footer a { color: ' . $settings['link_color'] . ' !important; }' . "\n";
			}
			...
			if ( $settings['button_color_alt'] != '' ) {
				$output .= 'a.button.alt { background: ' . $settings['button_color_alt'] . ' !important; border-color: ' . $settings['button_color_alt'] . ' !important; }' . "\n";
				$output .= 'a.button.alt:hover, a.button.alt.hover, a.button.alt.active { background: ' . $settings['button_color_alt'] . ' !important; opacity: 0.9; }' . "\n";
			}

			if ( '' != $settings['homepage_intro_message_bg'] ) {
				$output .= '#intro-message.home-section { background-image: url(' . esc_url( $settings['homepage_intro_message_bg'] ) . '); }';
			}
		...
		if ( is_array($woo_options) ) {
			...
			if ( isset( $woo_options['woo_typography'] ) && $woo_options['woo_typography'] == 'true' ) {
				...
				if ( isset( $woo_options['woo_font_nav'] ) && $woo_options['woo_font_nav'] )
					$output .= 'body #navigation .nav a { '.woo_generate_font_css( $woo_options['woo_font_nav'], '1.4' ).' }' . "\n";	
				...
				if ( isset( $woo_options['woo_font_post_meta'] ) && $woo_options['woo_font_post_meta'] )
					$output .= '.post .post-meta ul li { '.woo_generate_font_css($woo_options[ 'woo_font_post_meta' ]).' }' . "\n";	
				...
				// Introductory Message Header
				if ( isset( $woo_options['woo_font_introductory_message_header'] ) && $woo_options['woo_font_introductory_message_header'] )
					$output .= 'body .home-section#intro-message header h1 { ' . woo_generate_font_css( $woo_options[ 'woo_font_introductory_message_header' ] ) . ' }'  . "\n";

				// Introductory Message Text
				if ( isset( $woo_options['woo_font_introductory_message_subtext'] ) && $woo_options['woo_font_introductory_message_subtext'] )
					$output .= 'body .home-section#intro-message p { ' . woo_generate_font_css( $woo_options[ 'woo_font_introductory_message_subtext' ] ) . ' }'  . "\n";	
